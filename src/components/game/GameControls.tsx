...
const ICON_BUTTON_CLASS =
  "w-10 h-10 bg-slate-900/60 border-cyan-500/30 hover:bg-cyan-500/20 hover:border-cyan-500/50 transition-all";
const TOUCH_BUTTON_CLASS =
  "h-16 bg-slate-900/80 border-cyan-500/30 hover:bg-cyan-500/20 active:bg-cyan-500/40 transition-all";
