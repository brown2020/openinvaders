...
export const metadata: Metadata = {
  ...
  description:
    "A beautifully crafted remake of the classic Space Invaders arcade game with modern visuals and smooth gameplay.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${pixelFont.variable} antialiased`} suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
